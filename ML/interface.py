...
def getFaceMeasurements(f):
    ...
    faceMeasurementsCoords = [( (abs(coordsList[16][0] - coords[ 0][0]))**2 + (abs(coordsList[16][1] - coords[ 0][1]))**2 )**(1/2),
                              ( (abs(coordsList[42][0] - coords[39][0]))**2 + (abs(coordsList[42][1] - coords[39][1]))**2 )**(1/2)]
